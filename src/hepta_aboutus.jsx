...
function AboutUs() {
    ...
    <div className="w-full h-auto flex flex-col items-center justify-center bg-gray-100 overflow-x-hidden">
        <div className="w-full h-screen flex flex-col items-center justify-center bg-gray-100">
                ...
                <h1 className="text-white font-bold w-[550px] text-[70px] text-center relative bottom-[420px]">About Us</h1>
        ...
        <h1 className="w-[320px] text-4xl font-bold relative left-[50px]">Welcome Travel & Tours</h1>
        ...
        <button className="w-[150px] border-2 p-3 relative top-[100px]">Learn More</button>
          ...
          <div className="h-auto w-full flex flex-wrap flex-col items-center justify-center pt-[80px]">
          <h1 className="text-[40px] text-center font-bold">International Tour</h1>
          <p className="w-[710px] text-center text-[18px] pt-[30px]">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live 
            the blind texts. Separated they live in Bookmarksgrove 
            right at the coast of the Semantics, a large language ocean.</p>
            <div className="h-auto w-full flex flex-wrap items-center justify-center pt-[80px]">
            <Carousel images={images} interval={2000} />
            </div>
          </div>


          <div className="h-auto w-full flex flex-wrap flex-col items-center justify-center pt-[180px]">
          <h1 className="text-[40px] text-center font-bold">Team</h1>
          <p className="w-[710px] text-center text-[18px] pt-[30px]">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live 
            the blind texts. Separated they live in Bookmarksgrove 
            right at the coast of the Semantics, a large language ocean.</p>
            <div className="h-auto w-full flex flex-wrap items-center justify-center pt-[180px]">
              <span className="w-[350px] h-[480px] bg-white m-4 relative bottom-[140px]">
                <img src={person1} className="w-200px h-200px" alt="" />
                <h1 className="text-blue-200 pt-[35px] relative left-[20px]">CEO, Co-Founder</h1>
                <h1 className="text-2xl text-bold relative left-[20px]">Vince Richardson</h1>
                </span>

                <span className="w-[350px] h-[480px] bg-white m-4 relative bottom-[140px]">
                  <img src={person2} className="w-200px h-200px" alt="" />
                  <h1 className="text-blue-200 pt-[35px] relative left-[20px]">CEO, Co-Founder</h1>
                <h1 className="text-2xl text-bold relative left-[20px]">Vince Richardson</h1>
                  </span>

                  <span className="w-[350px] h-[480px] bg-white m-4 relative bottom-[140px]">
                    <img src={person3} className="w-200px h-200px" alt="" />
                    <h1 className="text-blue-200 pt-[35px] relative left-[20px]">CEO, Co-Founder</h1>
                <h1 className="text-2xl text-bold relative left-[20px]">Vince Richardson</h1>
                    </span>
            ...
            <div className="w-full h-[900px] bg-black flex flex-wrap items-center justify-center overflow-hidden">
