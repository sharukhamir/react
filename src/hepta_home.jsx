  ...
  return (
    ...
    {/* first section of main page ends here */}
      ...
      <div className="h-auto w-full flex flex-col items-center justify-center">
        <img src={second} className="w-[550px] h-[600px] relative top-[180px] right-[270px]" alt="image" />
        <div className="h-auto w-full flex flex-col items-center justify-center relative bottom-[400px] left-[200px]">
      ...
      <div className="h-auto w-full flex flex-wrap flex-col items-center justify-center pt-[170px]">
        <h1 className="">Experience Once In Your Life Time</h1>
        <p className="w-[650px]">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia,
      ...
      <div className="h-auto w-full flex flex-wrap flex-col items-center justify-center pt-[170px]">
        ...
        <p className="w-[650px]">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
      </div>
      <div className="h-auto w-full flex flex-wrap items-center justify-center pt-[420px]">
      <div class="custom-shape-divider-bottom-1746526066">
    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
        <path d="M1200 120L0 16.48 0 0 1200 0 1200 120z" class="shape-fill"></path>
    </svg>
    </div>
    <div className="h-[3500px] w-full flex flex-wrap items-center justify-center overflow-hidden">
    <div className="h-auto w-full flex flex-wrap items-center justify-center relative bottom-[800px]">
      <Carousel images={images} interval={2000} />
      {/* <span className="w-full h-[600px] bg-blue-400 relative bottom-[470px]"></span> */}
      <div style={{backgroundColor: "#4EC7D4",}} className="w-full h-500px] relative bottom-[500px]">
        ...
        <div style={{backgroundColor: "#4EC7D4",}} className="w-full h-500px] relative pt-[170px]">
          <div className="h-auto w-full flex flex-wrap items-center justify-center">
              ...
              <div className="w-full h-[700px] bg-white flex flex-wrap items-center justify-center">
      <h1 className="font-bold text-6xl relative top-[50px]">Happy Customers</h1>
      <div className="h-auto w-full flex flex-wrap items-center justify-center">
              <span className="w-[350px] h-[350px] bg-white m-4 relative bottom-[20px]">
      ...
      <div className="w-full flex flex-wrap flex-col items-center justify-center relative bottom-[350px]">
        ...
        <p className="w-[700px] text-[18px] text-center relative top-[25px]">Lorem ipsum dolor sit amet, consectetur adipisicing elit. In dolor, iusto doloremque quo
           ...
           <div className="w-full flex flex-wrap items-center justify-center pt-[100px]">
      ...
      <div className="w-full h-auto bg-black flex flex-wrap items-center justify-center relative bottom-[150px]">
